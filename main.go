...
func NewQuestions(question string) Question {
	return Question{question: question}
}

func newShortQuestion(question string) Question {
	q := NewQuestions(question)
...
func main() {
	questions := []Question{
		...
		newShortQuestion("What is your favourite anime ?"),
		newLongQuestion("Why do you even want to do programming ?, it suck's"),
	}
	m := New(questions)
